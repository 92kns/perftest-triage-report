...
func TestRenderHTML(t *testing.T) {
	...
	// writeHTMLReport creates outputHTML relative to the working directory;
	// run it in a temp dir so it does not drop a report.html in the repo.
	t.Chdir(t.TempDir())
	writeHTMLReport(reportInput{Results: results, Permas: permas})
